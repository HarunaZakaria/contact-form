...
This project is a contact form that I have to build using only HTML and CSS. In building this project I have to consider the mobile width and the desktop width wheich are 375px and 1440px respectively.
...
- Solution URL: https://harunazakaria.github.io/contact-form/
